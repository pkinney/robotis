defmodule Robotis.ControlTable.Tables do
  ...
  # XM430 series (W210, W350) - Protocol 2.0
  # Control table is nearly identical to XL330, same addresses and scaling
  ...
  @spec table(:xl320 | :xl330_m288 | :xm430) :: map()
  def table(:xl330_m288), do: @xl330_m288
  def table(:xm430), do: @xm430
